## Version Control
- Making sure there is a .git file in the repo, this ensures you can use git commands to view and extract infromation
...
## PDF 
- Using a tool like Metadatago can allow you to look for program anems, pdf versoin and softwares used to redact information. 
